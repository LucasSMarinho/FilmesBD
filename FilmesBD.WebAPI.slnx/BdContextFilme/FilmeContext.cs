...
namespace FilmesBD.WebAPI.slnx.BdContextFilme;
...
public partial class FilmeContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdFilme).HasName("PK__Filme__6E8F2A763D8666D0");
        ...
        {
            entity.HasKey(e => e.IdGenero).HasName("PK__Genero__0F8349886D9D3A41");
        });

        modelBuilder.Entity<Usuario>(entity =>
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__5B65BF979901B71D");
        });
